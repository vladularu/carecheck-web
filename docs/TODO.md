...
- [x] Gemeinsames Export-Vokabular fuer Monatsbericht, CSV, XLSX und Druck definieren.
- [x] Monatsbericht-Dateinamen fuer CSV, XLSX und Druck/PDF-Hinweis vereinheitlichen.
- [x] Exportvorschau in Dashboard und Monatsbericht anzeigen.
- [x] Berechnungsgrundlagen im Monatsbericht dokumentieren.
- [x] Pruefhinweise im Monatsbericht verstaendlicher darstellen, ohne Compliance-Logik zu aendern.
